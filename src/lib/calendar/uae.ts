...
export const UAE_CALENDAR: UaeDay[] = [
  ...
  // ---------- 2028 ----------
  { date: "2028-01-01", name: "New Year's Day", kind: "holiday" },
  { date: "2028-01-28", name: "Ramadan begins", kind: "religious", note: "Reduced working hours across the UAE" },
  { date: "2028-02-19", name: "Zayed Humanitarian Work Day", kind: "observance" },
  { date: "2028-02-25", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2028-02-26", name: "Eid Al Fitr", kind: "holiday" },
  { date: "2028-02-27", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2028-02-28", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2028-05-04", name: "Arafat Day", kind: "holiday" },
  { date: "2028-05-05", name: "Eid Al Adha", kind: "holiday" },
  { date: "2028-05-06", name: "Eid Al Adha Holiday", kind: "holiday" },
  { date: "2028-05-07", name: "Eid Al Adha Holiday", kind: "holiday" },
  { date: "2028-05-25", name: "Islamic New Year", kind: "holiday" },
  { date: "2028-08-03", name: "Prophet Muhammad's Birthday", kind: "holiday" },
  { date: "2028-08-28", name: "Emirati Women's Day", kind: "observance" },
  { date: "2028-11-01", name: "Union Pledge Day", kind: "observance" },
  { date: "2028-11-03", name: "UAE Flag Day", kind: "observance" },
  { date: "2028-12-01", name: "Commemoration Day", kind: "holiday" },
  { date: "2028-12-02", name: "UAE National Day", kind: "holiday" },
  { date: "2028-12-03", name: "UAE National Day Holiday", kind: "holiday" },

  // ---------- 2029 ----------
  { date: "2029-01-01", name: "New Year's Day", kind: "holiday" },
  { date: "2029-01-17", name: "Ramadan begins", kind: "religious", note: "Reduced working hours across the UAE" },
  { date: "2029-02-07", name: "Zayed Humanitarian Work Day", kind: "observance" },
  { date: "2029-02-14", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2029-02-15", name: "Eid Al Fitr", kind: "holiday" },
  { date: "2029-02-16", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2029-02-17", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2029-04-24", name: "Arafat Day", kind: "holiday" },
  { date: "2029-04-25", name: "Eid Al Adha", kind: "holiday" },
  { date: "2029-04-26", name: "Eid Al Adha Holiday", kind: "holiday" },
  { date: "2029-04-27", name: "Eid Al Adha Holiday", kind: "holiday" },
  { date: "2029-05-14", name: "Islamic New Year", kind: "holiday" },
  { date: "2029-07-24", name: "Prophet Muhammad's Birthday", kind: "holiday" },
  { date: "2029-08-28", name: "Emirati Women's Day", kind: "observance" },
  { date: "2029-11-01", name: "Union Pledge Day", kind: "observance" },
  { date: "2029-11-03", name: "UAE Flag Day", kind: "observance" },
  { date: "2029-12-01", name: "Commemoration Day", kind: "holiday" },
  { date: "2029-12-02", name: "UAE National Day", kind: "holiday" },
  { date: "2029-12-03", name: "UAE National Day Holiday", kind: "holiday" },

  // ---------- 2030 ----------
  { date: "2030-01-01", name: "New Year's Day", kind: "holiday" },
  { date: "2030-01-06", name: "Ramadan begins", kind: "religious", note: "Reduced working hours across the UAE" },
  { date: "2030-01-27", name: "Zayed Humanitarian Work Day", kind: "observance" },
  { date: "2030-02-04", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2030-02-05", name: "Eid Al Fitr", kind: "holiday" },
  { date: "2030-02-06", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2030-02-07", name: "Eid Al Fitr Holiday", kind: "holiday" },
  { date: "2030-04-13", name: "Arafat Day", kind: "holiday" },
  { date: "2030-04-14", name: "Eid Al Adha", kind: "holiday" },
  { date: "2030-04-15", name: "Eid Al Adha Holiday", kind: "holiday" },
  { date: "2030-04-16", name: "Eid Al Adha Holiday", kind: "holiday" },
  { date: "2030-05-04", name: "Islamic New Year", kind: "holiday" },
  { date: "2030-07-13", name: "Prophet Muhammad's Birthday", kind: "holiday" },
  { date: "2030-08-28", name: "Emirati Women's Day", kind: "observance" },
  { date: "2030-11-01", name: "Union Pledge Day", kind: "observance" },
  { date: "2030-11-03", name: "UAE Flag Day", kind: "observance" },
  { date: "2030-12-01", name: "Commemoration Day", kind: "holiday" },
  { date: "2030-12-02", name: "UAE National Day", kind: "holiday" },
  { date: "2030-12-03", name: "UAE National Day Holiday", kind: "holiday" },
  { date: "2030-12-26", name: "Ramadan begins", kind: "religious", note: "Reduced working hours across the UAE" },
];
